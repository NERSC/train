...
#DW stage_in source=/global/cscratch1/sd/djbard/train/csgf-hpc-day/IntroToBB/data  destination=$DW_JPERSISTENT_STRIPED_my_persistent_reservation/data  type=directory
