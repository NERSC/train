...
#SBATCH -J VTune_memory-access
#SBATCH -o VTune_memory-access.%j.out
...
vtuneopts="-collect memory-access"
...
vtuneopts+=" -r ${SCRATCH}/memory-access.${SLURM_JOB_NAME}.${SLURM_JOB_ID}"
...
# Enable detailed profiling for arrays of arbitrary size
vtuneopts+=" -knob analyze-mem-objects=true -knob mem-object-size-min-thres=0"
